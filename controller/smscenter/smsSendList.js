 ...
 */
appModule.controller('msgSendListCtrl',['$scope','$http','DTOptionsBuilder','DTColumnDefBuilder', 'apiService',function($scope,$http, DTOptionsBuilder, DTColumnDefBuilder, apiService){
    ...
    $scope.datatablesApi = function(postData){
        ...
        var _url = "api/v1/getBatchDetailReport"; //api/v1/getBatchReport
    ...
    $scope.datatablesMedia = function(listDatas){
        ...
        $('#smsSendListTable').DataTable(options);
